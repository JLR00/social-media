      ...
      <div className="post-card">
        ...
        <div className="post-reactions">
          <button
            ...
            className={`${hasUserLiked && "liked"} btn`}
          >
            {!hasUserLiked ? (
              <>
                <Icon icon="weui:like-outlined" className="icon" />
                Like
              </>
            ) : (
              <>
                <Icon icon="weui:like-filled" className="icon" />
                Unlike
              </>
            )}{" "}
            {/*&#128077; &#128078;*/}
          ...
          <button className="btn">
            <Icon icon="mynaui:share" className="icon" />
            Share
          </button>
        </div>
        <div>
